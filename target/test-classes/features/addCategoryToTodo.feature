Feature: As a user, I want to add a relationship categories with id of a todo
  Background:
    Given the app is running
        ...
        #normal_flow
  Scenario: Add a relationship between a specific todo and already defined category
    ...
    Examples:
      ...
      | 5            | 1           |
        ...
        #alternative_flow
  Scenario: Add a relationship between a specific todo and a created category
    #Given I have a todo with ID "<todo_id>"
    ...
    Examples:
      ...
      | 5        | testing | hello       | 1           |
        ...
        #error_flow
  Scenario: Add a relationship categories between a todo and a non existent category
